...
def login_page(page: ft.Page, navigate_to):
    ...
    username_field = ft.TextField(label="Username", on_change=lambda e: update_login_button_state())
    ...
    def handle_login(_):
        if login_user(username_field.value, password_field.value):
            navigate_to("home")
        else:
    ...
    def update_login_button_state():
        ...
        login_button.disabled = not (username_field.value and password_field.value)
        page.update()
